...
import com.inspur.common.view.HVScrollListView.HVScrollListView;
 ...
 */
public class RRRResListActivity extends Activity implements View.OnClickListener{
    ...
    private HVScrollListView hvslv_data;
...
//    	getPrintFormat();
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 1) {
                    ...
                    try {
                        ...
                        Log.i("ctitle", Arrays.toString(ctitle));
                        Log.i("etitle", Arrays.toString(etitle));
                        
                        hvslv_data.setTitle(ctitle);  
                        hvslv_data.setKey(etitle);
                        hvslv_data.setData(list_map);
                        
                        hvslv_data.init(cxt, true);
        ...
        printEye.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                List<Map<String, Object>> printData=hvslv_data.getSelectItems();
    ...
    protected void init() {
        ...
        hvslv_data=(HVScrollListView) this.findViewById(R.id.hvslv_data);
        
        
        cxt=RRRResListActivity.this;
        page=1;
        pageSize=20;
        totalPages=0;
